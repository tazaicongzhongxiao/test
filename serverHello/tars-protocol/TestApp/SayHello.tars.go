...
// This file was generated from SayHello.tars
...
// NewSayHello creates a new SayHello servant.
func NewSayHello() *SayHello {
	return new(SayHello)
}

// NewSayHelloClient creates a new SayHello client proxy for the given servant.
func NewSayHelloClient(servant string, comm *tars.Communicator, option ...tars.EndpointManagerOption) *SayHello {
	client := new(SayHello)
...
func (obj *SayHello) SetServant(servant model.Servant) {
	obj.servant = servant
}
...
func (obj *SayHello) TarsSetProtocol(p model.Protocol) {
	obj.servant.TarsSetProtocol(p)
}

// Endpoints returns all active endpoint.Endpoint
func (obj *SayHello) Endpoints() []*endpoint.Endpoint {
	return obj.servant.Endpoints()
}

// AddServant adds servant  for the service.
func (obj *SayHello) AddServant(imp SayHelloServant, servant string) {
	tars.AddServant(obj, imp, servant)
}

// AddServantWithContext adds servant  for the service with context.
func (obj *SayHello) AddServantWithContext(imp SayHelloServantWithContext, servant string) {
...
func (obj *SayHello) Add(a int32, b int32, c *int32, opts ...map[string]string) (int32, error) {
	return obj.AddWithContext(context.Background(), a, b, c, opts...)
}
...
func (obj *SayHello) AddWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	...
	if ok && trace.Call() {
		...
		tars.Trace(trace.GetTraceKey(tarstrace.EstCS), tarstrace.AnnotationCS, tars.GetClientConfig().ModuleName, obj.servant.Name(), "Add", 0, traceParam, "")
	}
	...
	if ok && trace.Call() {
		...
		tars.Trace(trace.GetTraceKey(tarstrace.EstCR), tarstrace.AnnotationCR, tars.GetClientConfig().ModuleName, obj.servant.Name(), "Add", tarsResp.IRet, traceParam, "")
	}
...
func (obj *SayHello) Sub(a int32, b int32, c *int32, opts ...map[string]string) (int32, error) {
	return obj.SubWithContext(context.Background(), a, b, c, opts...)
}
...
func (obj *SayHello) SubWithContext(tarsCtx context.Context, a int32, b int32, c *int32, opts ...map[string]string) (ret int32, err error) {
	...
	if ok && trace.Call() {
		...
		tars.Trace(trace.GetTraceKey(tarstrace.EstCS), tarstrace.AnnotationCS, tars.GetClientConfig().ModuleName, obj.servant.Name(), "Sub", 0, traceParam, "")
	}
	...
	if ok && trace.Call() {
		...
		tars.Trace(trace.GetTraceKey(tarstrace.EstCR), tarstrace.AnnotationCR, tars.GetClientConfig().ModuleName, obj.servant.Name(), "Sub", tarsResp.IRet, traceParam, "")
	}
...
func (obj *SayHello) Dispatch(tarsCtx context.Context, val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, withContext bool) (err error) {
	...
	case "Add":
		...
		if ok && trace.Call() {
			...
			tars.Trace(trace.GetTraceKey(tarstrace.EstSR), tarstrace.AnnotationSR, tars.GetClientConfig().ModuleName, tarsReq.SServantName, "Add", 0, traceParam, "")
		}
		...
		if ok && trace.Call() {
			...
			tars.Trace(trace.GetTraceKey(tarstrace.EstSS), tarstrace.AnnotationSS, tars.GetClientConfig().ModuleName, tarsReq.SServantName, "Add", 0, traceParam, "")
		}
	case "Sub":
		var a int32
		var b int32
		...
		if ok && trace.Call() {
			...
			tars.Trace(trace.GetTraceKey(tarstrace.EstSR), tarstrace.AnnotationSR, tars.GetClientConfig().ModuleName, tarsReq.SServantName, "Sub", 0, traceParam, "")
		}
		...
		if ok && trace.Call() {
			...
			tars.Trace(trace.GetTraceKey(tarstrace.EstSS), tarstrace.AnnotationSS, tars.GetClientConfig().ModuleName, tarsReq.SServantName, "Sub", 0, traceParam, "")
		}
